...
(cl:defmethod cl:initialize-instance :after ((m <TopologicalNode>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TopologicalNode)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vitaslam-msg:<TopologicalNode> is deprecated: use vitaslam-msg:TopologicalNode instead.")))
...
(cl:defmethod pose-val ((m <TopologicalNode>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vitaslam-msg:pose-val is deprecated.  Use vitaslam-msg:pose instead.")
  (pose m))
