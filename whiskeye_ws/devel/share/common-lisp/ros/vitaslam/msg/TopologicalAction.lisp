...
(cl:defmethod cl:initialize-instance :after ((m <TopologicalAction>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TopologicalAction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vitaslam-msg:<TopologicalAction> is deprecated: use vitaslam-msg:TopologicalAction instead.")))
...
(cl:defmethod action-val ((m <TopologicalAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vitaslam-msg:action-val is deprecated.  Use vitaslam-msg:action instead.")
  (action m))

(cl:ensure-generic-function 'src_id-val :lambda-list '(m))
(cl:defmethod src_id-val ((m <TopologicalAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vitaslam-msg:src_id-val is deprecated.  Use vitaslam-msg:src_id instead.")
  (src_id m))

(cl:ensure-generic-function 'dest_id-val :lambda-list '(m))
(cl:defmethod dest_id-val ((m <TopologicalAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vitaslam-msg:dest_id-val is deprecated.  Use vitaslam-msg:dest_id instead.")
  (dest_id m))
