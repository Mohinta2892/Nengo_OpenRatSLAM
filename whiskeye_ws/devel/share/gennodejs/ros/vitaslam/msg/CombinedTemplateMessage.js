...
class CombinedTemplateMessage {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CombinedTemplateMessage(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CombinedTemplateMessage(null);
...
module.exports = CombinedTemplateMessage;
