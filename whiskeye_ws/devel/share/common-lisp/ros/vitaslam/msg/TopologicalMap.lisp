...
(cl:defclass <TopologicalMap> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (node
    :reader node
    :initarg :node
    :type (cl:vector vitaslam-msg:TopologicalNode)
   :initform (cl:make-array 0 :element-type 'vitaslam-msg:TopologicalNode :initial-element (cl:make-instance 'vitaslam-msg:TopologicalNode)))
   (edge_count
    :reader edge_count
    :initarg :edge_count
    :type cl:integer
   ...
   (edge
    :reader edge
    :initarg :edge
    :type (cl:vector vitaslam-msg:TopologicalEdge)
   :initform (cl:make-array 0 :element-type 'vitaslam-msg:TopologicalEdge :initial-element (cl:make-instance 'vitaslam-msg:TopologicalEdge))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TopologicalMap>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TopologicalMap)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vitaslam-msg:<TopologicalMap> is deprecated: use vitaslam-msg:TopologicalMap instead.")))
...
(cl:defmethod node_count-val ((m <TopologicalMap>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vitaslam-msg:node_count-val is deprecated.  Use vitaslam-msg:node_count instead.")
  (node_count m))

(cl:ensure-generic-function 'node-val :lambda-list '(m))
(cl:defmethod node-val ((m <TopologicalMap>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vitaslam-msg:node-val is deprecated.  Use vitaslam-msg:node instead.")
  (node m))

(cl:ensure-generic-function 'edge_count-val :lambda-list '(m))
(cl:defmethod edge_count-val ((m <TopologicalMap>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vitaslam-msg:edge_count-val is deprecated.  Use vitaslam-msg:edge_count instead.")
  (edge_count m))

(cl:ensure-generic-function 'edge-val :lambda-list '(m))
(cl:defmethod edge-val ((m <TopologicalMap>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vitaslam-msg:edge-val is deprecated.  Use vitaslam-msg:edge instead.")
  (edge m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TopologicalMap>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'node)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'vitaslam-msg:TopologicalNode))
  ...
  (cl:let ((vals (cl:slot-value msg 'edge)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'vitaslam-msg:TopologicalEdge))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
