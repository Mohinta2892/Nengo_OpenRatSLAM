...
(cl:defmethod cl:initialize-instance :after ((m <TopologicalEdge>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TopologicalEdge)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vitaslam-msg:<TopologicalEdge> is deprecated: use vitaslam-msg:TopologicalEdge instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <TopologicalEdge>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vitaslam-msg:id-val is deprecated.  Use vitaslam-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'source_id-val :lambda-list '(m))
(cl:defmethod source_id-val ((m <TopologicalEdge>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vitaslam-msg:source_id-val is deprecated.  Use vitaslam-msg:source_id instead.")
  (source_id m))

(cl:ensure-generic-function 'destination_id-val :lambda-list '(m))
(cl:defmethod destination_id-val ((m <TopologicalEdge>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vitaslam-msg:destination_id-val is deprecated.  Use vitaslam-msg:destination_id instead.")
  (destination_id m))

(cl:ensure-generic-function 'duration-val :lambda-list '(m))
(cl:defmethod duration-val ((m <TopologicalEdge>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vitaslam-msg:duration-val is deprecated.  Use vitaslam-msg:duration instead.")
  (duration m))

(cl:ensure-generic-function 'transform-val :lambda-list '(m))
(cl:defmethod transform-val ((m <TopologicalEdge>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vitaslam-msg:transform-val is deprecated.  Use vitaslam-msg:transform instead.")
  (transform m))
